      ...
      <div className="max-w-[1100px] mx-auto px-6 py-16 grid md:grid-cols-[260px_1fr] gap-12">
        ...
        <div className="space-y-12 text-[15px] text-gray-700 leading-relaxed">
          ...
          <section id="section-7">
            ...
            <div className="space-y-3">
              <p><strong>7.1</strong> We communicate by email and WhatsApp. Please use the contact details on our website: WhatsApp <a href="https://wa.me/923451644916" className="text-[#d4af37] hover:underline">+92 345 1644916</a>, email <a href="mailto:Legal@Repukeel.com" className="text-[#d4af37] hover:underline">Legal@Repukeel.com</a>.</p>
          ...
          <section id="section-18">
            ...
            <p><strong>18.1</strong> RepuKeel, P33H+GVV, G-7/4, Islamabad, Pakistan. WhatsApp: <a href="https://wa.me/923451644916" className="text-[#d4af37] hover:underline">+92 345 1644916</a>. Email: <a href="mailto:Legal@Repukeel.com" className="text-[#d4af37] hover:underline">Legal@Repukeel.com</a>. Website: <a href="https://repukeel.vercel.app" className="text-[#d4af37] hover:underline">repukeel.vercel.app</a>.</p>
          </section>
